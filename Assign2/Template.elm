...
view model = div [class "w3-card w3-grey w3-margin"] [
             ...
             [
                          ...
                          [
                            ...
                            , p [mainCardFont]
                               [ i [ class "fa fa-github-square fa-fw w3-margin-right w3-large w3-text-indigo"]
                                    []
                                ,a [href "https://github.com/Rublinstd"]
                       ...
                       h3 [ class "w3-text-grey w3-padding-16 w3-margin-left" ]
                        ...
                        [
                          ...
                          [
                            ...
                            li []
                            [text "Proficient in various computer / information technology (IT) skills and Database Design as seen in project work including the management of SQL Database servers, development in the .NET framework, all while exhibiting knowledge of Windows software design standards (as defined by documentation published by Microsoft)."],
                            li []
                            [text "Learned flexibility/adaptability through jazz improvisation bands as well as took initiative in leading a number of musical groups."]
                      ...
                      h3 [ class "w3-text-grey w3-padding-16 w3-margin-left" ]
                       ...
                       [
                          ...
                          [
                            ...
                            li []
                            [text "Developed a finalist project for the SASS Data Analytics Competition"],
                            li []
                    ...
                    [
                      h3 [ class "w3-text-grey w3-padding-16 w3-margin-left" ]
                       ...
                       [
                          ...
                          [
                            li []
                            [text "Developed strong verbal communication and teamwork skills while working alongside co-workers and managers."]
                          ],
                          h6 [ class " w3-large w3-text-indigo"]
                          [
                ...
                [
                  ...
                  a [href "href https://github.com/Rublinstd", classList [(footerBarItem,True),("fa fa-github-square",True)]][],
